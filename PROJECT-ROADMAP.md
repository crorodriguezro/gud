...
| `E1-T04` Implement long-lived sequential multi-frame receive | P0 | verified (qualified) | E1-T03 | The historical production `status-on-set-aio` gate completed 100 exact 12,800-byte transactions with final Idle and zero transport faults: `../gud-gadget/evidence/functionfs-status-on-set-e1-t04-hs-rerun-20260818T022645Z/`. The final clean-source rerun failed before SET_BUFFER/accepted I/O because its rebuilt host stage binary returned atomic-commit `EINVAL`; it is not yet reproducible without qualification. Evidence: `../gud-gadget/evidence/functionfs-status-on-set-e1-t04-clean-source-rerun-20260818T025417Z/`. Do not start E1-T05 until this unchanged gate passes from exact clean artifacts. |
